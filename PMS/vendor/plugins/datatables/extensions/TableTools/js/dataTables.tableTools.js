	...
	receiveEvent: function(eventName, args) {
		...
		switch (eventName) {
			case 'load':
				...
				// bug fix: Cannot extend EMBED DOM elements in FirePMS, must use traditional function
				...
				// firePMS on pc needs a "kick" in order to set these in certain cases
				if (!this.ready && navigator.userAgent.match(/FirePMS/) && navigator.userAgent.match(/Windows/)) {
					self = this;
...
TableTools.DEFAULTS = {
	...
	"oTags": {
		"container": "div",
		"button": "a", // We really want to use buttons here, but FirePMS and IE ignore the
